...
namespace RimWorld
{
	public class WorkGiver_ConstructSmoothWall : WorkGiver
	{
		...
		{
            return pawn.Faction == Faction.OfColony && Find.DesignationManager.DesignationAt(c, DefDatabase<DesignationDef>.GetNamed("SmoothWalls") ) != null && pawn.CanReserveAndReach(c, PathMode.Touch, Danger.Some);
		}
